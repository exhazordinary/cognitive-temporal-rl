...
def run_single_experiment(config: SurNoRConfig, seed: int) -> dict:
    ...
    agent = SurNoRPPO(
        ...
        vol_window_short=config.vol_window_short,
        vol_window_long=config.vol_window_long,
        vol_change_threshold=config.vol_change_threshold,
        vol_noise_sensitivity=config.vol_noise_sensitivity,
        vol_volatility_boost=config.vol_volatility_boost,
        vol_rollout_window=config.vol_rollout_window,
